...
public class ClientView {
	...
	public void printMemberChangeTrue() {
		System.out.println();
		System.out.println("회원정보변경 성공!");
	}

	public void printMemberChangeFalse() {
		System.out.println();
		System.out.println("회원정보변경 실패...");
	}

	public MemberVO getChangePw() {
		System.out.print("변경할 비밀번호 입력) ");
		String mpw = sc.next();
		return new MemberVO(null, mpw, null);
	}
	...
	public int printClientMenu02(MemberVO mVO) {
		...
		System.out.println("현재 로그인한 사용자 [" + mVO.getName() + "]");
