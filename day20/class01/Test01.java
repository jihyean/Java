...
public class Test01 {
	public static void main(String[] args) {
		// 1. 웹페이지 코드를자바로 가져오기
		final String url = "https://media.naver.com/press/009/ranking?type=comment&date=20230531";
		...
		Elements elems3 = doc.select("div.list_content>span.list_comment");
		System.out.println(elems3);
